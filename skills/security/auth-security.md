...
Use existing `secureCompare()` — same as ingest secret validation.
...
- [ ] `LIFEOS_INGEST_SECRET` is high-entropy random string
...
4. `LIFEOS_INGEST_SECRET` + update Android bridge config
